...
# User Configuration
USER_CERTIFICATE = 'azurecheck.pem'
SUBSCRIPTION_ID= 'cfe9f693-a31d-4137-be23-97d7c34804dd'
...
def main():
    h = HostedService(subscription_id="cfe9f693-a31d-4137-be23-97d7c34804dd") 
    h.list()
